...
app.post('/getSolutionFromGPT', upload.single('file'), async (req, res) => {
    ...
    fs.readFile(`${file.path}`, 'utf8', (err, data) => {
        ...
        const requestJson = {
            ...
            Примечание: коды могут отличаться друг от друга визуально, главное проверить конечный результат, правильный ли он. Еще нужно учитывать, что коды могут быть на разных языках, поэтому ученику надо написать скорректированный код, на том языке, на котором прислал запрос
