...
app.post('/getSolutionFromGPT', upload.single('file'), async (req, res) => {
    ...
    fs.readFile(`${file.path}`, 'utf8', (err, data) => {
        ...
        const requestJson = {
            ...
            Объясни, в чем он не прав, выделяя каждый пункт, обращаясь к ученику на Вы. Напиши очень коротко (максимум 450 символов) и ясно.
            Пришли ученику скорректированный код на языке, который прислал тебе ученик, если написал что-либо неправильно, или некорректно или похвали ученика за похожий по правильности код.
            `,
